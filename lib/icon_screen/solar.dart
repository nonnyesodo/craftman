...
class Solar extends StatefulWidget {
  const Solar({Key? key}) : super(key: key);

  @override
  SolarState createState() => SolarState();
}

class SolarState extends State<Solar> {
  String address = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('solar').snapshots(),
